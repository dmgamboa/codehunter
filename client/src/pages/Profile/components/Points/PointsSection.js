        ...
        <>
            <PSStyle>
                <div id="digits">
                    <pre>
                        <span
                            style={{ color: "#005526", fontWeight: "1000", fontSize: "300%" }}
                ...
                <div id="redeemBtn">
                    <Button type="primary" id="redeemBtn" onClick={showModal}>
                        Redeem Points
                    </Button>
                </div>
                ...
                >
                    <p id="confirmationText">Are you sure you want</p>
                    <p id="confirmationText">to redeem your points?</p>
                </Modal>
            </PSStyle>
        </>
    );
